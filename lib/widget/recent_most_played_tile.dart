...
class RecentTile extends StatefulWidget {
  ...
  @override
  State<RecentTile> createState() => _RecentMostTileState();
}

class _RecentMostTileState extends State<RecentTile> {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      //         child: IconButton(
      //           onPressed: () {
      //             // Recents.removefromRecent(
      //             //   context: context,
      //             //   id: widget.songList[widget.index].id,
      //             // );
      //             // MostPlayed.removefromMostPlayed(
